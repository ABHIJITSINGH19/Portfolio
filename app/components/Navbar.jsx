    ...
    <>
      ...
      <nav
        className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${
          isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheam dark:shadow-white/20" : ""
        }`}
      >
        <a href="#top" className="text-4xl md:text-5xl font-Ovo text-gray-800 font-semibold">ABHI {`</>`}
          {/* <Image
            src={assets.logo}
            alt=""
            className="w-28"
