        ...
        <div className="flex-1 flex flex-col justify-center min-h-[20rem] space-y-6">
          ...
          <ul className="grid grid-cols-auto sm:grid-cols-2 gap-6">
            {infoList.map(({ icon, iconDark, title, description }, index) => (
              <li
                key={index}
                className="border border-gray-300 rounded-xl p-8 shadow-md transition-transform transform hover:scale-105 hover:shadow-xl bg-white flex items-center space-x-4"
              >
